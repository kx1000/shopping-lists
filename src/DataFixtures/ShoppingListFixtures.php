...
class ShoppingListFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $categoryFood = $this->getReference(CategoryFixtures::REF_CATEGORY_FOOD);
        /** @var Category $categoryBills */
        $categoryBills = $this->getReference(CategoryFixtures::REF_CATEGORY_BILLS);
        /** @var Category $categoryChemistry */
        $categoryChemistry = $this->getReference(CategoryFixtures::REF_CATEGORY_CHEMISTRY);
